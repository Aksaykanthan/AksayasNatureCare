                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-6 d-flex d-sm-block flex-column align-items-center'>
                            <h1 className='mb-0 text-white fw-300'>Health is a state of complete harmony of the</h1>
                            <h1 id = "glow" className='mb-5 text-white fw-bold text-center text-sm-start'>body, mind & spirit.</h1>
                            {/* <MenuBtn /> */}
                        </div>
                    </div>
                </div>
